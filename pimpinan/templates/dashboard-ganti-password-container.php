		...
		<div class="col-lg-8 col-md-9 col-sm-8">
			...
			<?php if (isset($_GET['err'])) { ?>
	            ...
	            <div class="alert alert-danger alert-dismissible" role="alert">
	              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true" onclick="window.location.href='http://localhost/project_blk/pimpinan/dashboard'">&times;</span></button>
	              <?= $_GET['err'] ?>
	            </div>
			...
			<form action="http://localhost/project_blk/pimpinan/config/ganti_password.php" method="POST">
