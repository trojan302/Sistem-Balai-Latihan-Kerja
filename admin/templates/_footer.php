    <script src="http://localhost/project_blk/libs/js/jquery.js"></script>
    <script src="http://localhost/project_blk/libs/js/Chart.min.js"></script>
    <script src="http://localhost/project_blk/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="http://localhost/project_blk/admin/node_modules/main.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/project_blk/admin/node_modules/admin.js"></script>    
  </body>
</html>