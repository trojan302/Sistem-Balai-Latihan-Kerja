<div class="editor-panel">
  ...
  <div class="btn-group" role="group" aria-label="...">
    ...
    <form id="formEditor" action="" method="POST" class="form-horizontal" onsubmit="return false">
      ...
      <input type="text" id="judulLoker" class="form-control">
      <br>
      <label>Closing Date</label>
      <input type="date" id="closingDate" class="form-control">  
      <br>
      <iframe id="deskripsiEditor" name="editor" frameborder="0" class="body-editor"></iframe><br>
      <input type="submit" onclick="tambahLoker()" value="Tambahkan Loker" class="btn btn-info">
    </form>
</div>