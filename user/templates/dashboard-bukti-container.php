		...
		<div class="col-lg-8 col-md-9 col-sm-8">
			...
			<div class="panel panel-default">
			  <div class="panel-heading">
				  ...
				  <span class="pull-right"><a href="./print?print=bukti_daftar&id=<?= $peserta['id_peserta'] ?>" class="btn btn-xs btn-primary" target="_blank"><i class="glyphicon glyphicon-print"></i> Print Bukti</a></span>
