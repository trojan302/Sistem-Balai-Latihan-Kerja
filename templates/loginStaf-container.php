      <div class="starter-template">
        <h1>Login Staf Balai Latihan Kerja</h1>
        <hr>
        ...
        <form action="http://localhost/project_blk/config/prosesLoginStaf.php" method="POST">
            <form>
              <div class="input-group input-group-md">
                ...
                <input type="text" class="form-control" placeholder="Username Atau Email" aria-describedby="sizing-addon" name="usernameOrEmail" required>
              </div>
              <br>
              <div class="input-group input-group-md">
                <span class="input-group-addon" id="sizing-addon">
              ...
              <br>
              <input type="submit" name="loginStaf" value="Login" class="btn btn-default">
            </form>
        </form>
      </div>